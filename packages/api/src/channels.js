module.exports = function (app) {
  ...
  app.on('login', (authResult, { connection }) => {
    ...
    if (connection) {
      ...
      // Easily organize players by email and userid for things like messaging
  ...
  // app.service('players').publish('created', () => app.channel('admins'));

  // With the userid and email organization from above you can easily select involved players
