...
module.exports = {
  before: {
    ...
    find: [],
    get: [],
    create: [validateTeams(), checkTableStatus(), isTableInGame()],
    update: [checkTableStatus(), isTableInGame()],
    patch: [checkTableStatus(), isTableInGame()],
  ...
  after: {
    ...
    find: [],
    get: [],
    create: [startStopMatchEmitter(), setTableInGame()],
    update: [startStopMatchEmitter(), setTableInGame(), setTableAvailable()],
    patch: [startStopMatchEmitter(), setTableInGame(), setTableAvailable()],
    remove: [stopMatchEmitter(), setTableAvailable()],
  },
