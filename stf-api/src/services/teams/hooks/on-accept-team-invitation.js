...
module.exports = function () {
  return async context => {
    ...
    if (editedTeam[models.teams.fields.invited] && context.data[models.teams.fields.players].length > 1) {
      ...
      `
      const invitationHost = editedTeam[models.teams.fields.players].find(playerId => playerId !== invitedPlayer._id)
